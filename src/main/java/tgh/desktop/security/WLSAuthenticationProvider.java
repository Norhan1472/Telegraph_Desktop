...
import tgh.desktop.repos.UserPermissionRepo;
import tgh.desktop.repos.UserRepo;
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		System.out.println("name in WLSAuthenticationProvider = " + name);
        	...
        	if(name!= null) {
    			...
    			tgh.desktop.models.User user = this.userRepository.findByUSERNAME(name);
    			...
    			tgh.desktop.models.User user = this.userRepository.findByUSERNAME(userNAME);
